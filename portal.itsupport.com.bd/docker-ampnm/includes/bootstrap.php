...
// These are passed as environment variables from docker-compose.yml
define('LICENSE_API_URL', getenv('LICENSE_API_URL') ?: '');
define('APP_LICENSE_KEY', getenv('APP_LICENSE_KEY') ?: '');

// Get or generate a unique installation ID for this AMPNM instance
// This ID is used to bind the license to a specific installation
define('AMPNM_INSTALLATION_ID', getInstallationId());

// Store license details in session after successful verification
// These will be populated by checkAmpnmLicense()
if (!isset($_SESSION['license_status'])) {
    $_SESSION['license_status'] = 'unknown';
    $_SESSION['license_message'] = 'License not yet checked.';

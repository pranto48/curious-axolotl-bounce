    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (page === 'index.php') {
            ...
            // The dist folder is at /var/www/html/app-root/dist, so relative path is ../app-root/dist
            const reactBuildPath = '../app-root/dist/index.html'; 
            fetch(reactBuildPath)
                ...
                .then(html => {
                    ...
                    if (reactLink) {
                        ...
                        newLink.href = '../app-root/dist' + reactLink.getAttribute('href');
                    ...
                    if (reactScript) {
                        ...
                        newScript.src = '../app-root/dist' + reactScript.getAttribute('src');

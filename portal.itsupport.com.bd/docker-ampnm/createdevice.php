...
if (!$is_admin) {
    echo '<main id="app"><div class="container mx-auto px-4 py-8"><div class="bg-red-500/20 border border-red-500/30 text-red-300 text-sm rounded-lg p-4 text-center">Forbidden: Only admin users can create devices.</div></div></main>';
    include 'footer.php';
    exit;
}
?>
...
<main id="app">
    <div class="container mx-auto px-4 py-8">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="devices.php" class="px-4 py-2 bg-slate-700 text-white rounded-lg hover:bg-slate-600">
        ...
        <div class="bg-slate-800 border border-slate-700 rounded-lg shadow-xl p-6 w-full max-w-md mx-auto">
            <h2 class="text-xl font-semibold text-white mb-4">Device Details</h2>
            <form id="createDevicePageForm" class="flex flex-col space-y-4">
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="deviceIp" name="ip" placeholder="IP Address (optional)" class="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-2 focus:ring-2 focus:ring-cyan-500">
                </div>
                <div>
